...
<?PHP
   ...
   // Enviar consulta
      $instruccion = "insert into usuarios (password, Name, apellidos, dni, saldo, tipo, email) values ('$password', '$nombre', '$apellidos', '$dni', '$saldo', '$tipo', '$email')";
